...
class TicTacToe:
    def __init__(self):
        self.board = [' ' for _ in range(9)]  # single list rep 3*3 board
    ...
    def print_board_nums():
        ...
        # Shows the numbering scheme of the game board)
    ...
    def available_moves(self):
        ...
        # moves = []
        # # enumerate retrieves index and value of each element in the iteration
    ...
    def num_empty_squares(self):
        return self.board.count(' ')  # Count no of empty squares in the list
